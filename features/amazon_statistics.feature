...
Feature:
  ...
  Scenario: see how much money I earned when sales have different currencies
    Given I upload "kdp-report-04-2011.xls"
    ...
    # Then I should see "6.84€" were earned in "Jul"
    # GBP
    # Then I should see "£1.00" were earned on "Amazon"
    # Then I should see "£1.00" were earned in "Apr" by "Amazon"
    # Then I should see "£1.00" were earned in "Jul" by "Amazon"
    # Then I should see "£1.00" were earned in "Apr"
    # Then I should see "£1.00" were earned in "Jul"
